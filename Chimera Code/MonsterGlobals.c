...
// pointer to the big old monster array for the game
// alloc'd when first requested on new game, dealloc'd when it ends
creatureType *storedMonsters = NULL;
monsterWords *storedWords = NULL;

creatureType *getMonsterCatalog() {
    if (storedMonsters != NULL) {
        return storedMonsters;
    }
    
    storedMonsters = (creatureType[]) {
